...
"""GMY changed: 云深处lite3的配置"""
DeepRobotic_LITE3_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/user/IsaacLab/scripts/reinforcement_learning/rsl_rl/urdf_convert/lite3/lite3.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 100.4),        # GMY: pos=(0.0, 0.0, 0.4),
        joint_pos={
            ".*L_HipX_joint": 0.1,
            ".*R_HipX_joint": -0.1,
...
DeepRobotic_X30_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/user/IsaacLab/scripts/reinforcement_learning/rsl_rl/urdf_convert/x30/x30.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
